...
var _user$project$Main$reversedComparison = F2(
	function (a, b) {
...
var _user$project$Main$calcTimeDiff = F2(
	function (timeOld, timeNew) {
		var defaultConfig = _alpacaaa$elm_date_distance$Date_Distance$defaultConfig;
		var config = _elm_lang$core$Native_Utils.update(
			defaultConfig,
			{includeSeconds: true});
		var inWords = _alpacaaa$elm_date_distance$Date_Distance$inWordsWithConfig(config);
		return A2(
			inWords,
			_elm_lang$core$Date$fromTime(timeOld),
			_elm_lang$core$Date$fromTime(timeNew));
	});
var _user$project$Main$cryptoCompareUrl = function (coin) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://www.cryptocompare.com/coins/',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$String$toLower(coin.base),
			A2(_elm_lang$core$Basics_ops['++'], '/forum/', coin.quote)));
};
var _user$project$Main$coinigyUrl = function (coin) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$Main$exchangeUrl = function (coin) {
	var _p1 = coin.exchange;
	switch (_p1) {
		case 'BINA':
			return A2(
				_elm_lang$core$Basics_ops['++'],
		...
		case 'CPIA':
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					coin.base,
					A2(_elm_lang$core$Basics_ops['++'], '_', coin.quote)));
		case 'PLNX':
			return A2(
				_elm_lang$core$Basics_ops['++'],
		...
		return A2(
			_elm_lang$html$Html$article,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'message ', messageClass)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
	...
	function (txt, notifType, closeMsg) {
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'notification ', notifClass)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Main$disabledAttribute = function (isDisabled) {
	return isDisabled ? A2(_elm_lang$html$Html_Attributes$attribute, 'disabled', 'true') : A2(_elm_lang$html$Html_Attributes$attribute, 'data-empty', '');
};
var _user$project$Main$icon = F3(
	function (icon, spin, isLeft) {
		var classIcon = isLeft ? 'icon is-left' : 'icon';
		var spinner = spin ? ' fa-spin' : '';
		var className = A2(
			_elm_lang$core$Basics_ops['++'],
			'fa',
			A2(
				_elm_lang$core$Basics_ops['++'],
				spinner,
				A2(_elm_lang$core$Basics_ops['++'], ' fa-', icon)));
		return A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(classIcon),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Main$loadingIcon = function (model) {
	return model.isLoading ? A3(_user$project$Main$icon, 'spinner', true, false) : _elm_lang$html$Html$text('');
};
var _user$project$Main$modalCard = F6(
			...
			if (_p6.ctor === 'Just') {
				return A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_p6._0._1),
							_1: {
								ctor: '::',
								_0: _user$project$Main$disabledAttribute(model.isLoading),
								_1: {ctor: '[]'}
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p6._0._0),
						_1: {ctor: '[]'}
					});
			} else {
				return _elm_lang$html$Html$text('');
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('modal-card'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('modal-card-head'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('modal-card-title'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(close),
														_1: {ctor: '[]'}
													}
												}
											},
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('modal-card-body'),
										_1: {ctor: '[]'}
									},
									body),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('modal-card-foot'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _user$project$Main$fieldInput = F6(
	function (model, fieldLabel, fieldValue, fieldPlaceHolder, fieldIcon, fieldMsg) {
		var loadingClass = model.isLoading ? ' is-loading' : '';
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('label is-large'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								A2(_elm_lang$core$Basics_ops['++'], 'control has-icons-left has-icons-right', loadingClass)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder(fieldPlaceHolder),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$type_('text'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$defaultValue(fieldValue),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(fieldMsg),
													_1: {ctor: '[]'}
												}
											}
										}
							...
							_1: {
								ctor: '::',
								_0: A3(_user$project$Main$icon, fieldIcon, false, true),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Main$selectInput = F6(
	function (model, optionsType, fieldLabel, fieldValue, fieldIcon, fieldMsg) {
		var loadingClass = model.isLoading ? ' is-loading' : '';
		var options = A2(
			_elm_lang$core$List$map,
			function (_p7) {
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								A2(_elm_lang$core$Basics_ops['++'], 'control has-icons-left', loadingClass)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('select is-large is-fullwidth'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('From -> To (%)'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: A3(_user$project$Main$icon, 'clock', false, false),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
											...
											_0: _elm_lang$html$Html$text(
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														item.exchange,
														A2(_elm_lang$core$Basics_ops['++'], '] ', item.market)))),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$a,
													{
														...
														_0: _elm_lang$html$Html_Attributes$href(
															_user$project$Main$exchangeUrl(item)),
														_1: {
															ctor: '::',
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$a,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href(
																_user$project$Main$coinigyUrl(item)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$target('_blank'),
																_1: {ctor: '[]'}
														...
														{
															ctor: '::',
															_0: A3(_user$project$Main$icon, 'bar-chart', false, false),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$a,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href(
																	_user$project$Main$cryptoCompareUrl(item)),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$target('_blank'),
																	_1: {ctor: '[]'}
															...
															{
																ctor: '::',
																_0: A3(_user$project$Main$icon, 'comments', false, false),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: _elm_lang$html$Html$text(
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		_elm_lang$core$Basics$toString(item.from),
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			' -> ',
																			A2(
																		...
																		{ctor: '[]'},
																		{
																			...
																			_0: _elm_lang$html$Html$text(
																				A2(
																					...
																					A2(
																						_elm_lang$core$Basics_ops['++'],
																						A2(_cuducos$elm_format_number$FormatNumber$format, _cuducos$elm_format_number$FormatNumber_Locales$usLocale, item.percentage),
																						'%)'))),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
														...
														_1: {
															...
															_0: A2(
																...
																{ctor: '[]'},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		A2(_user$project$Main$calcTimeDiff, item.time, model.currentTime)),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
...
var _user$project$Main$handleResponseErrors = F3(
	function (model, err, msg) {
		var error = function () {
			...
			switch (_p9.ctor) {
				case 'BadStatus':
					...
					return A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_p10.status.code),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' - ',
							_elm_lang$core$Basics$toString(_p10.body)));
				case 'BadPayload':
					return _p9._0;
				default:
		...
		var _p11 = A2(_elm_lang$core$Debug$log, msg, err);
		return {
			ctor: '_Tuple2',
...
var _user$project$Main$coinCard = F3(
	function (coin, filter, currentTime) {
		var _p13 = (_elm_lang$core$Native_Utils.cmp(coin.percentage, 0) < 0) ? {
			ctor: '_Tuple2',
			_0: 'has-text-danger',
			_1: A2(
				_elm_lang$html$Html$span,
		...
		var titleColor = _p13._0;
		var percentIcon = _p13._1;
		var percentage = A2(
			_elm_lang$core$Basics_ops['++'],
																...
																},
																{
																	...
																	_0: A2(
																		...
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(
																				A2(_user$project$Main$calcTimeDiff, coin.time, currentTime)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}),
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$a,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href(
												_user$project$Main$exchangeUrl(coin)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$target('_blank'),
												_1: {
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href(
													_user$project$Main$coinigyUrl(coin)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$target('_blank'),
													_1: {
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href(
														_user$project$Main$cryptoCompareUrl(coin)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$target('_blank'),
														_1: {
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('BTC Volume (24h)'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
														...
														{ctor: '[]'},
														{
															...
															_0: _elm_lang$html$Html$text(
																A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		_user$project$Main$periodToString(model.filter.period),
																		')'))),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
				...
				_0: A2(
					...
					A2(
															...
															_0: A2(
																...
																{ctor: '[]'},
																{
																	...
																	_0: _elm_lang$html$Html$text(
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			A2(_cuducos$elm_format_number$FormatNumber$format, _cuducos$elm_format_number$FormatNumber_Locales$usLocale, percentage),
																			'%')),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
						...
						A2(
							...
							F2(
								function (a, b) {
									var _p15 = A2(_elm_lang$core$Basics$compare, a.exchange, b.exchange);
									if (_p15.ctor === 'EQ') {
										var _p16 = A2(_elm_lang$core$Basics$compare, a.quote, b.quote);
										if (_p16.ctor === 'EQ') {
...
var _user$project$Main$removeNewCoins = F2(
	function (oldCoins, newCoin) {
		return A2(
...
var _user$project$Main$getMarketId = F3(
	function (model, exchange, market) {
		return _elm_lang$core$List$head(
			A2(
				...
				A2(
					...
					function (i) {
						return _elm_lang$core$Native_Utils.eq(i.market, market) && _elm_lang$core$Native_Utils.eq(i.exchange, exchange);
					},
					model.watchMarkets)));
	});
var _user$project$Main$saveUser = _elm_lang$core$Native_Platform.outgoingPort(
	'saveUser',
	function (v) {
		return {id: v.id, email: v.email, name: v.name, apiKey: v.apiKey, apiSecret: v.apiSecret, apiChannelKey: v.apiChannelKey};
	});
var _user$project$Main$saveExchanges = _elm_lang$core$Native_Platform.outgoingPort(
	'saveExchanges',
	function (v) {
		return {
			user: {id: v.user.id, email: v.user.email, name: v.user.name, apiKey: v.user.apiKey, apiSecret: v.user.apiSecret, apiChannelKey: v.user.apiChannelKey},
			exchanges: _elm_lang$core$Native_List.toArray(v.exchanges).map(
				function (v) {
					return {id: v.id, code: v.code, name: v.name};
				})
		};
	});
var _user$project$Main$deleteUser = _elm_lang$core$Native_Platform.outgoingPort(
	'deleteUser',
	function (v) {
		return null;
	});
			...
			exchanges: _elm_lang$core$Native_List.toArray(v.exchanges).map(
				function (v) {
					return {
						...
						time: v.time,
						period3m: (v.period3m.ctor === 'Nothing') ? null : {min: v.period3m._0.min, max: v.period3m._0.max, diff: v.period3m._0.diff, percentage: v.period3m._0.percentage},
						period5m: (v.period5m.ctor === 'Nothing') ? null : {min: v.period5m._0.min, max: v.period5m._0.max, diff: v.period5m._0.diff, percentage: v.period5m._0.percentage},
						period10m: (v.period10m.ctor === 'Nothing') ? null : {min: v.period10m._0.min, max: v.period10m._0.max, diff: v.period10m._0.diff, percentage: v.period10m._0.percentage},
						period15m: (v.period15m.ctor === 'Nothing') ? null : {min: v.period15m._0.min, max: v.period15m._0.max, diff: v.period15m._0.diff, percentage: v.period15m._0.percentage},
						period30m: (v.period30m.ctor === 'Nothing') ? null : {min: v.period30m._0.min, max: v.period30m._0.max, diff: v.period30m._0.diff, percentage: v.period30m._0.percentage}
					};
				})
		};
	});
...
var _user$project$Main$coinigySocketConnection = _elm_lang$core$Native_Platform.incomingPort('coinigySocketConnection', _elm_lang$core$Json_Decode$bool);
var _user$project$Main$Flags = F2(
	function (a, b) {
		return {user: a, exchanges: b};
	});
var _user$project$Main$User = F6(
	function (a, b, c, d, e, f) {
		return {id: a, email: b, name: c, apiKey: d, apiSecret: e, apiChannelKey: f};
	});
...
var _user$project$Main$Exchange = F3(
	function (a, b, c) {
		return {id: a, code: b, name: c};
	});
var _user$project$Main$exchangesDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'data',
	_elm_lang$core$Json_Decode$list(
		A3(
			...
			A3(
				...
				A3(
					...
					'exch_id',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Exchange))))));
													...
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return {filter: a, oldFilter: b, watchMarkets: c, coins: d, history: e, showFilter: f, setupStep: g, exchanges: h, availableExchanges: i, isMuted: j, isLoading: k, user: l, error: m, content: n, coinigySocketsConnected: o, transactionsBook: p, orderBook: q, currentTime: r};
																	};
																};
															};
														};
...
var _user$project$Main$Filter = F3(
	function (a, b, c) {
		return {volume: a, period: b, percentage: c};
	});
var _user$project$Main$Coin = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Main$watchListCoinDecoder = function () {
	var toDecoder = F8(
		function (exchangeCode, exchangeId, market, from, to, volume, btcVolume, serverTime) {
			var _p17 = function () {
				var _p18 = A2(_elm_lang$core$String$split, '/', market);
				if (((_p18.ctor === '::') && (_p18._1.ctor === '::')) && (_p18._1._1.ctor === '[]')) {
					return {ctor: '_Tuple2', _0: _p18._0, _1: _p18._1._0};
				} else {
			...
			return _elm_lang$core$Json_Decode$succeed(
				_user$project$Main$Coin(exchangeCode)(exchangeId)(base)(quote)(market)(
					A2(
						...
						0.0,
						_elm_lang$core$String$toFloat(from)))(
					A2(
						_elm_lang$core$Result$withDefault,
						0.0,
						_elm_lang$core$String$toFloat(to)))(
					A2(
						_elm_lang$core$Result$withDefault,
						0.0,
						_elm_lang$core$String$toFloat(volume)))(
					A2(
						_elm_lang$core$Result$withDefault,
						0.0,
...
var _user$project$Main$Period = F4(
	function (a, b, c, d) {
		return {min: a, max: b, diff: c, percentage: d};
	});
var _user$project$Main$Transaction = F6(
	function (a, b, c, d, e, f) {
		return {id: a, tradeType: b, price: c, quantity: d, time: e, marketId: f};
	});
var _user$project$Main$Order = F5(
	function (a, b, c, d, e) {
		return {tradeType: a, price: b, quantity: c, time: d, marketId: e};
	});
...
var _user$project$Main$ExchangesSetup = {ctor: 'ExchangesSetup'};
var _user$project$Main$UserSetup = {ctor: 'UserSetup'};
var _user$project$Main$MarketWatch = {ctor: 'MarketWatch'};
var _user$project$Main$MyReports = {ctor: 'MyReports'};
var _user$project$Main$ActiveTrades = {ctor: 'ActiveTrades'};
var _user$project$Main$BaseCracker = {ctor: 'BaseCracker'};
var _user$project$Main$DaytradeScanner = {ctor: 'DaytradeScanner'};
var _user$project$Main$Period30m = {ctor: 'Period30m'};
...
var _user$project$Main$initialModel = {
	...
	history: {ctor: '[]'},
	watchMarkets: {ctor: '[]'},
	filter: _user$project$Main$initialFilter,
	oldFilter: _elm_lang$core$Maybe$Nothing,
	showFilter: false,
	setupStep: _user$project$Main$None,
	isMuted: false,
	isLoading: false,
	user: A6(_user$project$Main$User, '', '', '', '', '', ''),
	exchanges: {ctor: '[]'},
...
var _user$project$Main$initModel = function (flags) {
	var loggedIn = !_elm_lang$core$String$isEmpty(flags.user.id);
	return _elm_lang$core$Native_Utils.update(
		_user$project$Main$initialModel,
		{setupStep: _user$project$Main$None, user: flags.user});
};
...
var _user$project$Main$stringToPeriod = function (period) {
	...
	switch (_p20) {
		...
		case '5m':
			return _user$project$Main$Period5m;
		case '10m':
			return _user$project$Main$Period10m;
		case '15m':
			return _user$project$Main$Period15m;
		case '30m':
			return _user$project$Main$Period30m;
		default:
			return _user$project$Main$Period5m;
	}
};
...
var _user$project$Main$ToggleSound = {ctor: 'ToggleSound'};
var _user$project$Main$DeleteError = {ctor: 'DeleteError'};
...
var _user$project$Main$updateUserSetup = function (model) {
	if (_elm_lang$core$String$isEmpty(model.user.apiKey) || _elm_lang$core$String$isEmpty(model.user.apiSecret)) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					error: _elm_lang$core$Maybe$Just('Please fill API Key and API Secret')
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	} else {
		...
		var request = _elm_lang$http$Http$request(
			{
				...
				url: url,
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$Main$userDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		var cmd = A2(_elm_lang$http$Http$send, _user$project$Main$UserKeysResponse, request);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{error: _elm_lang$core$Maybe$Nothing, isLoading: true}),
			_1: cmd
		};
	}
};
		...
		switch (_p21.ctor) {
			...
			case 'Logout':
				return {
					...
					_1: _user$project$Main$deleteUser(
						{ctor: '_Tuple0'})
				};
			case 'DeleteError':
				return {
				...
				var playAlarm = (!model.isMuted) && A2(
					...
					_elm_lang$core$List$length(
						A2(
							_elm_lang$core$List$filter,
							function (i) {
								return _elm_lang$core$Native_Utils.cmp(i.time, model.currentTime - (_elm_lang$core$Time$second * 11)) > -1;
							},
							updatedCoins)));
			...
			case 'ShowFilter':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							showFilter: true,
							oldFilter: _elm_lang$core$Maybe$Just(model.filter)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleSetup':
			...
			case 'ResetFilter':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							oldFilter: _elm_lang$core$Maybe$Nothing,
							filter: A2(_elm_lang$core$Maybe$withDefault, _user$project$Main$initialFilter, model.oldFilter),
							showFilter: false
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'UserKeysResponse':
				if (_p21._0.ctor === 'Ok') {
					...
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{user: newUser, error: _elm_lang$core$Maybe$Nothing, isLoading: true});
					return {
						ctor: '_Tuple2',
						_0: newModel,
...
var _user$project$Main$ExchangesResponse = function (a) {
	...
	var request = _elm_lang$http$Http$request(
		{
			...
			url: url,
			body: _elm_lang$http$Http$emptyBody,
			expect: _elm_lang$http$Http$expectJson(_user$project$Main$exchangesDecoder),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
	var cmd = A2(_elm_lang$http$Http$send, _user$project$Main$ExchangesResponse, request);
	return cmd;
};
var _user$project$Main$init = function (flags) {
	var model = _user$project$Main$initModel(flags);
	var cmd = (!_elm_lang$core$String$isEmpty(model.user.id)) ? {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{isLoading: true}),
...
var _user$project$Main$UpdateUserSetup = {ctor: 'UpdateUserSetup'};
var _user$project$Main$UpdateCoinigyChannelKey = function (a) {
	return {ctor: 'UpdateCoinigyChannelKey', _0: a};
};
var _user$project$Main$UpdateCoinigySecret = function (a) {
	return {ctor: 'UpdateCoinigySecret', _0: a};
};
var _user$project$Main$UpdateCoinigyKey = function (a) {
	return {ctor: 'UpdateCoinigyKey', _0: a};
};
var _user$project$Main$ToggleSetup = function (a) {
	return {ctor: 'ToggleSetup', _0: a};
};
var _user$project$Main$setupModal = function (model) {
		...
		switch (_p24.ctor) {
			case 'UserSetup':
				return {
					...
					_0: {
						ctor: '::',
						_0: A6(_user$project$Main$fieldInput, model, 'Coinigy Key', userData.apiKey, 'Your Coinigy API Key', 'key', _user$project$Main$UpdateCoinigyKey),
						_1: {
							ctor: '::',
							_0: A6(_user$project$Main$fieldInput, model, 'Coinigy Secret', userData.apiSecret, 'Your Coinigy API Secret', 'lock', _user$project$Main$UpdateCoinigySecret),
							_1: {ctor: '[]'}
						}
					},
					_1: _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: 'Submit', _1: _user$project$Main$UpdateUserSetup}),
					_2: _elm_lang$core$Maybe$Just(
						{
							ctor: '_Tuple2',
							_0: 'Cancel',
							_1: _user$project$Main$ToggleSetup(_user$project$Main$None)
						})
				};
			case 'ExchangesSetup':
				return {
									...
									},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'Welcome ',
												A2(_elm_lang$core$Basics_ops['++'], userData.name, '!'))),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Looks like you don\'t have any Favorited Market on Coinigy. Please add them inside coinigy and refresh the page!'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			default:
				return {
					...
					_0: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Ooops... Something is wrong here!'),
						_1: {ctor: '[]'}
					},
					_1: _elm_lang$core$Maybe$Nothing,
					_2: _elm_lang$core$Maybe$Nothing
	...
	return A6(
		...
		_user$project$Main$ToggleSetup(_user$project$Main$None),
		{
			ctor: '::',
			_0: A2(
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$errorAlert(model),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$topMenu = function (model) {
	var loggedOut = _elm_lang$core$String$isEmpty(model.user.id);
	var content = function () {
		if (loggedOut) {
						...
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Main$ToggleSetup(_user$project$Main$UserSetup)),
								_1: {ctor: '[]'}
							}
						},
						{
			...
			var soundIcon = A2(
				_elm_lang$core$Basics_ops['++'],
				'fa fa-2x ',
				model.isMuted ? 'fa-volume-off has-text-danger' : 'fa-volume-up has-text-success');
			return {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$p,
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-label', 'main navigation'),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('navbar-brand logo'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('CryptoTradingBuddy'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$scannerContent = function (model) {
	var history = (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(model.history),
		0) > 0) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('m-t-lg'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
	...
	var filtering = A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(filter.percentage),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'%, ',
				A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(filtering),
							_1: {
								ctor: '::',
								_0: A3(_user$project$Main$icon, 'cog', false, false),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Main$mainContent = function (model) {
	if (_elm_lang$core$String$isEmpty(model.user.id)) {
		return A2(
			_elm_lang$html$Html$section,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('hero is-info is-large'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Not just a Scanner or Market Aggregator...'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('title logo'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('I\'m going to be your BEST buddy in your tradings :)'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
		...
		var content = function () {
			...
			switch (_p25.ctor) {
				...
				case 'DaytradeScanner':
					return _user$project$Main$scannerContent(model);
				case 'BaseCracker':
					return A2(
						_elm_lang$html$Html$p,
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Here we are going to automate/manage the AWESOME base cracker scanner created by Nathan Smith - For now, run it manually from '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$a,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('https://github.com/highmindedlowlife/trading-scripts'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('his Github repository.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				case 'ActiveTrades':
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Here we will keep track of our current active trades, where to layer in from the base and calculate break-even percentages of them'),
							_1: {ctor: '[]'}
						});
				default:
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Here we summarize all of our trades in all exchanges, see the profit and loss to keep track of our gains'),
							_1: {ctor: '[]'}
						});
			}
		}();
...
var _user$project$Main$SetFilter = {ctor: 'SetFilter'};
var _user$project$Main$UpdatePeriod = function (a) {
	return {ctor: 'UpdatePeriod', _0: a};
};
var _user$project$Main$UpdatePercentage = function (a) {
	return {ctor: 'UpdatePercentage', _0: a};
};
var _user$project$Main$UpdateVolume = function (a) {
	return {ctor: 'UpdateVolume', _0: a};
};
var _user$project$Main$filterModal = function (model) {
	var filterData = model.filter;
	var percentage = _elm_lang$core$Basics$toString(filterData.percentage);
	var period = filterData.period;
	var volume = _elm_lang$core$Basics$toString(filterData.volume);
	var modalClass = model.showFilter ? 'modal is-active' : 'modal';
	var periodOptions = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '3m', _1: '3 Minutes Period'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '5m', _1: '5 Minutes Period'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '10m', _1: '10 Minutes Period'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '15m', _1: '15 Minutes Period'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: '30m', _1: '30 Minutes Period'},
						_1: {ctor: '[]'}
					}
				}
			}
	...
	return A6(
		...
		_user$project$Main$ResetFilter,
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$form,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A6(
						_user$project$Main$selectInput,
						model,
						periodOptions,
						'Period',
						_user$project$Main$periodToString(period),
						'clock-o',
						_user$project$Main$UpdatePeriod),
					_1: {
						ctor: '::',
		...
		_elm_lang$core$Maybe$Just(
			{ctor: '_Tuple2', _0: 'Submit', _1: _user$project$Main$SetFilter}),
		_elm_lang$core$Maybe$Just(
			{ctor: '_Tuple2', _0: 'Cancel', _1: _user$project$Main$ResetFilter}));
};
var _user$project$Main$view = function (model) {
	var modal = model.showFilter ? _user$project$Main$filterModal(model) : ((!_elm_lang$core$Native_Utils.eq(model.setupStep, _user$project$Main$None)) ? _user$project$Main$setupModal(model) : _elm_lang$html$Html$text(''));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Main$topMenu(model),
			_1: {
				ctor: '::',
													...
													_1: {
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$href('http://leordev.github.io'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Leo Ribeiro'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text('. The source code is licensed '),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$a,
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href('http://opensource.org/licenses/mit-license.php'),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('MIT'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
			...
			return A2(
				...
				A2(
					...
					A2(
													...
													return A2(
														...
														function (id) {
															return A2(
																...
																function (name) {
																	return _elm_lang$core$Json_Decode$succeed(
																		{apiChannelKey: apiChannelKey, apiKey: apiKey, apiSecret: apiSecret, email: email, id: id, name: name});
																},
						...
						A2(_elm_lang$core$Json_Decode$field, 'apiChannelKey', _elm_lang$core$Json_Decode$string))));
		},
		A2(
			_elm_lang$core$Json_Decode$field,
			'exchanges',

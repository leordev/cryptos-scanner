																	...
																	_0: _elm_lang$html$Html$text(
																		A2(
																			...
																			A2(
																				...
																				_elm_lang$core$Basics$abs(percentage)),
																			'%')),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {filter: a, oldFilter: b, watchMarkets: c, coins: d, history: e, showFilter: f, setupStep: g, exchanges: h, availableExchanges: i, isMuted: j, isLoading: k, user: l, error: m, content: n, coinigySocketsConnected: o, transactionsBook: p, orderBook: q};
																};
															};
														};
													};
...
var _user$project$Main$calcPercentages = F2(
	function (coins, history) {
		return A2(
			...
			function (coin) {
				...
				var calcPeriod = function (period) {
					var pastCoins = A2(
						_elm_lang$core$List$filter,
						function (oldCoin) {
							...
							return _elm_lang$core$Native_Utils.eq(oldCoin.marketId, coin.marketId) && (_elm_lang$core$Native_Utils.cmp(currentDate - oldDate, period) < 1);
						},
						history);
					var minPrice = A2(
						_elm_lang$core$Maybe$withDefault,
					...
					var maxPrice = A2(
						...
						_elm_lang$core$List$maximum(
							A2(
								...
								{ctor: '::', _0: coin, _1: pastCoins})));
					var diffPrices = (maxPrice - minPrice) * -1;
					var percentagePrices = (_elm_lang$core$Native_Utils.cmp(
						_elm_lang$core$Basics$abs(diffPrices),
						0) > 0) ? (((minPrice / maxPrice) - 1) * 100) : 0;
					return _elm_lang$core$Maybe$Just(
						A4(_user$project$Main$Period, minPrice, maxPrice, diffPrices, percentagePrices));
				};
				return _elm_lang$core$Native_Utils.update(
					coin,
					{
						period3m: calcPeriod(3 * _elm_lang$core$Time$minute),
						period5m: calcPeriod(5 * _elm_lang$core$Time$minute),
						period10m: calcPeriod(10 * _elm_lang$core$Time$minute),
						period15m: calcPeriod(15 * _elm_lang$core$Time$minute),
						period30m: calcPeriod(30 * _elm_lang$core$Time$minute)
					});
			},
			coins);
	});
